...
check(
    ...
    'claude_home_path("skills", "task-progress"' in slack_src,
)
check(
...
check(
    ...
    'claude_home_path("skills", "task-progress"' in discord_src,
)
check(
...
check(
    ...
    'claude_home_path("skills", "task-progress"' in telegram_src,
)
check(
