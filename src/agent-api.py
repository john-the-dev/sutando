...
#               etc. Override via sutando.config.local.json (workspace.path);
#               $SUTANDO_WORKSPACE is deprecated since v0.8 (#1440) — detected
#               for a one-time migration warning but the value is ignored.
